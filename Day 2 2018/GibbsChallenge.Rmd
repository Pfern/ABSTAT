...
* Learn about <https://en.wikipedia.org/wiki/Multinomial_distribution>Multinomial ditribution. For the three-dimensional case we have:

${\bf X}=(X_1,X_2,X_3)\frown Multinomial(n;\theta_1,\theta_2,\theta_3)$\\
{\color{white}aaa} where $X_i\in\{0,1,2,\ldots\}$\: and\: $\theta_1+\theta_2+\theta_3=1\quad (\theta_i>0)$\\
...
* Learn about <https://en.wikipedia.org/wiki/Dirichlet_distribution>Dirichlet ditribution. For the three-dimensional case we have:
